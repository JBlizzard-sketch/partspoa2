...
export default function HotDealsPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const response = await fetch('/api/products?hot_deals=true&limit=24');
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-r from-red-600 via-pink-600 to-orange-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-red-100">Limited time offers on popular auto parts</p>
          </div>
        </section>
